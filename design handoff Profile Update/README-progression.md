...
from duplicates and the season track. Anything animated (Vault Ring, Bloom, Eclipse, Amber
...
| Finish | Rate | Duplicate value |
|---|---|---|
| Glossy | 1 in 12 (8.3 %) | 8 shards |
| Rainbow | 1 in 60 (1.7 %) | 40 shards |
| Static | 1 in 240 (0.4 %) | 120 shards |
