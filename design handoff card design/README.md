# Handoff: TCG Card System — "Reliquary"
...
14 + 51 + 5 + 362 + 5 + 29 + 4 + 128 + 4 + 56 + 14 = **672** ✓
...
**Layout:** fixed 480 × 672 box, `position: relative`, padding `14px 39px`, radius 12,
...
- Budget: ~26 characters before ellipsis. Longer names should be authored shorter, not shrunk.
...
- 480 × 672, radius 12, 2px solid `#C8A45C`, `overflow: hidden`.
...
interface Card {
  id: string;
  name: string;          // ~26 chars before ellipsis
  level: 1 | 2 | 3;
...
`4 · 5 · 6 · 8 · 9 · 11 · 12 · 13 · 14 · 18 · 20 · 39`
