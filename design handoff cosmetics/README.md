...
| `README-cosmetics.md` | Handoff for the 30 cosmetics, their shop icons and the five victory seals (companion document). |
| `Cosmetics Catalogue.dc.html` | All 30 cosmetics drawn as artifacts, each with its shop icon. |
| `Victory Seals.dc.html` | The five victory seal stamps, animated. |
