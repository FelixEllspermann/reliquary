...
- **`NetMessages.cs`** (liegt in Engine/, weil der DuelHost die `Sduel*`-Typen braucht): ein großes flaches Nachrichtenformat für alles — Auth, Profile, Packs, Decks, Kosmetik, Rang, `sduel`-Duellverkehr.
